...
<template>
  <div>
    <BaseModal
      ...
      <template #footer>
        <BaseButton text="Done" @click="close" />
      </template>
    </BaseModal>

    <BaseModal
      :is-open="activeModal === 'conditions'"
      title="Conditions"
      class="modal-wide"
      @close="close">
      <div class="sw-form-section">
...
export default {
  ...
  methods: {
    close() {
      this.$emit('update:activeModal', null)
    },
