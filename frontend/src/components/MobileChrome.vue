...
const NAV_ICON = {
  ...
  forecast:
    '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 19V5M4 19H20M4 19L8 13L12 15L16 9L20 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  settings:
  ...
  computed: {
    ...
    tabs() {
      return [
        ...
        {
          path: resolveAppPath('/forecast'),
          label: 'Forecast',
          icon: NAV_ICON.forecast,
          names: ['Forecast', 'MobileForecast']
        },
        {
